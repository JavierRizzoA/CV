...
\begin{aside}
  ...
  \section{%
    ...
    ~
  \section{Email}
    \href{mailto:javier@javierrizzo.com}{\textbf{javier}@javierrizzo.com}
    ~
  \section{Web \& Git}
  ...
  \section{%
    ...
    \langen{Other Skills}}
    HTML5, CSS3, Bash, Android, iOS, Git, Node.js, SQL, WPF, \langes{Electrónica}\langen{Electronics}, Arduino, \LaTeX
  ~
  \section{Hobbies}
  ...
  \section{%
    ...
    \textbf{%
      ...
      ~
      ~
\emph{\langes{Última actualización:\\Febrero 3, 2020}%
  \langen{Last update:\\February 3rd, 2020}}
\end{aside}
...
\fi
  ...
  {\langes{FIRST Robotics Competition (San Diego, Estados Unidos)}%
    \langen{FIRST Robotics Competition (San Diego, USA)}}
